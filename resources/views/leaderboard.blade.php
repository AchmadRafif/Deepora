...
<div class="container" style="max-width: 800px;">
    ...
    <div class="card">
        ...
        <div style="display: flex; align-items: center; padding: 1rem 0; border-bottom: 1px solid rgba(255,255,255,0.05); {{ $loop->last ? 'border-bottom: none' : '' }}">
            ...
            <div style="width: 40px; height: 40px; border-radius: 50%; background: {{ $user->avatar_color }}; display: flex; align-items: center; justify-content: center; font-weight: 700; margin: 0 1rem;">
